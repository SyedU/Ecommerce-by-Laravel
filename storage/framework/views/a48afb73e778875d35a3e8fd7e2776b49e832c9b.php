<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="row">
                <form action="<?php echo e(url('final/checkout')); ?>" method="post">
                  <?php echo csrf_field(); ?>
                    <div class="col-md-8">
