...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend_assets/css/slick.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend_assets/css/meanmenu.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend_assets/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend_assets/css/media.css')); ?>">
...
<body>
    ...
    <nav class="mobile-menu hidden">
        <a href="index.html">
            <img src="<?php echo e(asset('frontend_assets/images/logo.png')); ?>" alt="logo">
        </a>
        <ul>
            <li class="">
                <a href="<?php echo e('/'); ?>">
            ...
            <li class="">
                ...
                <ul>
                    ...
                    <a class="" href="<?php echo e('/cart'); ?>">Cart</a>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo e(asset('frontend_assets/images/logo.png')); ?>" alt="logo" class="img-responsive">
                </a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  ?>
                    <li class="tahsan"><span><a href="#"><i class="fa fa-shopping-bag"></i><?php echo e(Total_Cart_Item()); ?> items</a>
                        </span>
	...
	<?php echo $__env->yieldContent('content'); ?>
        ...
        <script src="<?php echo e(asset('frontend_assets/js/slick.js')); ?>"></script>
        <script src="<?php echo e(asset('frontend_assets/js/jquery.countdown.min.js')); ?>"></script>
        <script src="<?php echo e(asset('frontend_assets/js/jquery.meanmenu.min.js')); ?>"></script>
        <script src="<?php echo e(asset('frontend_assets/js/handleCounter.js')); ?>"></script>
