      ...
      <section id="banner">
          ...
          <div class="banner-slider">
            <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="banner-img" style="background: url(<?php echo e(asset($banner->banner_image)); ?>) no-repeat center; background-size: cover">
                  <div class="container">
                      <div class="row">
                          <div class="col-md-5">
                              <div class="banner-content">
                                  <h1><?php echo e($banner->heading); ?></h1>
                                  <h2><?php echo e($banner->sub_heading); ?></h2>
                                  <p><?php echo e($banner->details); ?></p>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="newest-main">
                      <div class="col-md-4 col-sm-4">
                          <div class="newest-item">
                              <img src="<?php echo e(asset('frontend_assets/images/newest1.jpg')); ?>" alt="newest1" class="img-responsive">
                      ...
                      <div class="col-md-4 col-sm-4">
                          <div class="newest-item">
                              <img src="<?php echo e(asset('frontend_assets/images/newest2.jpg')); ?>" alt="newest1" class="img-responsive">
                              <div class="overlay1 text-center">
                                  <h2>2017</h2>
                                  <h3>car</h3>
                                  <a href="#">shop now</a>
                      ...
                      <div class="col-md-4 col-sm-4">
                          <div class="newest-item">
                              <img src="<?php echo e(asset('frontend_assets/images/newest3.jpg')); ?>" alt="newest1" class="img-responsive">
                              <div class="overlay1 text-center">
                                  <h2>best</h2>
                                  <h3>car</h3>
                                  <a href="#">shop now</a>
                      ...
                      <div class="featured-filter">
                          <div class="text-center">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <button class="btn btn-default filter-button" data-filter="<?php echo e($category->id); ?>"><?php echo e($category->category_name); ?></button>
                          ...
                          <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="gallery_product col-md-3 col-sm-4 filter everything <?php echo e($product->category_id); ?>">
                              <div class="featured-product">
                                  <a href="product-details.html"><img src="<?php echo e(asset($product->product_image)); ?>" alt="featured-product-img" class="img-responsive"></a>
                                  <div class="overlay2 text-center">
                                      <a href="#"><i class="fa fa-random"></i></a>
                                  </div>
                              </div>
                              <div class="feat-details">
                                  <p><?php echo e($product->product_name); ?></p><span>$ <?php echo e($product->product_price); ?></span>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="gallery_product col-md-3">
                              <div class="featured-product">
                                  <a href="product-details.html"><img src="<?php echo e(asset($product->product_image)); ?>" alt="featured-product-img" class="img-responsive"></a>
                                  <div class="overlay2 text-center">
                                      <a href="<?php echo e(url('add/cart')); ?>/<?php echo e($product->id); ?>"><i class="fa fa-shopping-basket"></i></a>
                                  </div>
                              </div>
                              <div class="feat-details">
                                  <p><?php echo e($product->product_name); ?></p><span>$ <?php echo e($product->product_price); ?></span>
                          ...
                          <div class="col-md-6">
                              <div class="testimonial-item">
                                  <div class="col-md-3 test-img">
                                      <img src="<?php echo e(asset($testimonial->testimonial_image)); ?>" alt="testimonial-img" class="img-responsive">
                                  </div>
                                  <div class="col-md-9 test-details">
                                      <h2><?php echo e($testimonial->testimonial_name); ?></h2>
                                      <h3><?php echo e($testimonial->testimonial_designation); ?></h3>
                                      <p><?php echo e($testimonial->testimonial_description); ?></p>
                                      <h4><?php echo e($testimonial->testimonial_signature); ?></h4>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="footer-main">
                          <div class="col-md-3 col-sm-6">
                              <div class="footer-logo">
                                  <a href="#"><img src="<?php echo e(asset('frontend_assets/images/footer-logo.png')); ?>" alt="footer-logo" class="img-responsive"></a>
